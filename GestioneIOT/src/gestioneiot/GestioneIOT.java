...
import gestioneiot.ManufacturingDateComparator;
/**
 *
 * @author angel
 */
public class GestioneIOT {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Logger.getLogger(GestioneIOT.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        SensorKit ssc1 = ssc.filter(new I2CSensorFilter(), new ManufacturingDateComparator());
